...
///////////////go back
var btnBack2 = document.createElement('button');
$(btnBack2).addClass('btn2 btnBack')
      var t2 = document.createTextNode('Go back');       // Create a text node
      btnBack2.appendChild(t2);
      document.body.appendChild(btnBack2);
...
var btnRandom2 = document.createElement('button');
$(btnRandom2).addClass('btn2 btnRandom')
      var rd2 = document.createTextNode('Randomize!');       // Create a text node
      btnRandom2.appendChild(rd2);
      document.body.appendChild(btnRandom2);
